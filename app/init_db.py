...
def init_db():
    ...
    if not get_user_confirmation("Please confirm again that you want to drop all tables"):
        print("Database initialization cancelled.")
        return
    ...
    try:
        ...
        session.commit()
        print("Geometries updated successfully")
        ...
        session.commit()
        print("Hourly count data imported successfully")
